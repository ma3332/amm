...
contract OurOwnPair is OurOwnLPERC20 {
    ...
    function mint(address to) external lock returns (uint256 liquidity) {
        ...
        uint256 balance0 = IOurOwnLPERC20(token0).balanceOf(address(this));
    ...
    function burn(
        ...
        balance0 = IOurOwnLPERC20(_token0).balanceOf(address(this));
    ...
    function skim(address to) external lock {
        ...
        _safeTransfer(
            _token0,
            to,
            IOurOwnLPERC20(_token0).balanceOf(address(this)).sub(reserve0)
        );
        _safeTransfer(
            _token1,
            to,
            IOurOwnLPERC20(_token1).balanceOf(address(this)).sub(reserve1)
        );
    }
    ...
    function sync() external lock {
        _update(
            IOurOwnLPERC20(token0).balanceOf(address(this)),
            IOurOwnLPERC20(token1).balanceOf(address(this)),
            reserve0,
            reserve1
        );
    }
